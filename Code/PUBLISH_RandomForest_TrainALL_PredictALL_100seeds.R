...
ALL_Syll_Loc_Data_XCandML <- subset(ALL_Syll_Loc_Data_XCandML_data, select = c(1:20,22)) #ALL: 2785 #Breeding: 2436
...
AllResults=data.frame(testrun=1:1000,accuracy=1:1000)
...
AllResults$accuracy[seedval] <- accuracy 

}

t.test(AllResults$accuracy[1:100]) #t = 819.14, df = 99, p-value < 2.2e-16 #95 percent confidence interval: 0.8888746 0.8931914 #sample estimates: mean of x 0.891033 

hist(AllResults$accuracy[1:100], breaks = 20)
