...
snp <- fasta2genlight("~/PUBLISH_aligned_fasta_spottedandeasterntowhee.fasta", snpOnly=T) #reads alignments with fasta format and extracts SNPs
#glPlot(snp)
...
genetics_towhee_metadata_import <- read.csv('~/PUBLISH_Genetic_Metadata_Spreadsheet.csv')
