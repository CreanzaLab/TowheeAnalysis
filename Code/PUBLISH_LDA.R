...
train_data <- ALL_Syll_Loc_Data_XCandML_data[train_indices, ] #ALL: 2091 #Breeding: 1827
test_data <- ALL_Syll_Loc_Data_XCandML_data[test_indices, ] #ALL: 697 #Breeding: 610
...
# Downsample each species to the minimum count
...
kappa_result #ALL: 0.7385886 #Breeding: 0.7865199 

Mcnemar_pvalue <- cm$overall["McnemarPValue"] 
Mcnemar_pvalue #ALL: 0.3373557 #Breeding: 0.0048503

#accuracy
accuracy <-cm$overall["Accuracy"]
accuracy #ALL: 0.8737446 #Breeding: 0.9

balanced_accuracy <- cm$byClass["Balanced Accuracy"]
balanced_accuracy #ALL: 0.8714951 #Breeding: 0.902719
