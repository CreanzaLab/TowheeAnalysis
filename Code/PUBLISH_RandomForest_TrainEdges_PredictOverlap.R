...
kappa_result #ALL: 0.8653247 #Breeding: 0.8497751

Mcnemar_pvalue <- cm$overall["McnemarPValue"] #ALL: 0.4226781 #Breeding: 0.3864762  
Mcnemar_pvalue

accuracy <-cm$overall["Accuracy"] #ALL: 0.9351852 #Breeding: 0.9281437 
accuracy

balanced_accuracy <- cm$byClass["Balanced Accuracy"] #ALL: 0.9362371 #Breeding: 0.9209745
balanced_accuracy
...
kappa_result2 #ALL: 0.678487 #Breeding: 0.7223937

Mcnemar_pvalue2 <- cm2$overall["McnemarPValue"] #ALL: 0.003551465 #Breeding: 0.0808556
Mcnemar_pvalue2

accuracy2 <-cm2$overall["Accuracy"] #ALL: 0.8425926 #Breeding: 0.8742515
accuracy2

balanced_accuracy2 <- cm2$byClass["Balanced Accuracy"] #ALL: 0.8344988 #Breeding: 0.8504608
balanced_accuracy2
