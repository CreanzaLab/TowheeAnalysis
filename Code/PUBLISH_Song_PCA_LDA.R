...
kappa_result #ALL: 0.4551325 #Breeding: 0.4444314

Mcnemar_pvalue <- cm$overall["McnemarPValue"] 
Mcnemar_pvalue #ALL: 1.64055e-06 #Breeding: 1.28512e-06 

#accuracy
accuracy <-cm$overall["Accuracy"]
accuracy #ALL: 0.7482066 #Breeding: 0.7521543

balanced_accuracy <- cm$byClass["Balanced Accuracy"]
balanced_accuracy #ALL: 0.7224146 #Breeding: 0.715491
