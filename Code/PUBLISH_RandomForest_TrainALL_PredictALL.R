...
kappa_result #ALL: 0.7844089 #Breeding: 0.840037 

Mcnemar_pvalue <- cm$overall["McnemarPValue"] #Breeding: 0.01012799
Mcnemar_pvalue #ALL: 0.0001801663 

accuracy <-cm$overall["Accuracy"] #ALL: 0.8952654 #Breeding: 0.9244663
accuracy

balanced_accuracy <- cm$byClass["Balanced Accuracy"]
balanced_accuracy #ALL: 0.9008931 #Breeding: 0.9280851
