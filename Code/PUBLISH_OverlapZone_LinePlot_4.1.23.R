...
#write.csv(ALL_Syll_Loc_Data_XCandML, "C:/Users/xxime/Box/Ximena_Nicole/TOWHEE_ANALYSES_2022-2023/1_PUBLISH_MATERIALS/DATA/PUBLISH_All_XCandML_songdata_with_overlapzone_4.1.23.csv") #for all samples
#write.csv(ALL_Syll_Loc_Data_XCandML, "C:/Users/xxime/Box/Ximena_Nicole/TOWHEE_ANALYSES_2022-2023/1_PUBLISH_MATERIALS/DATA/PUBLISH_breedingseasonONLY_XCandML_songdata_with_overlapzone_4.1.23.csv") #for breeding season samples only 
