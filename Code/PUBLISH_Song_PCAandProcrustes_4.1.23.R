...
ALL_Syll_Loc_Data_XCandML <- read.csv("C:/Users/xxime/Box/Ximena_Nicole/TOWHEE_ANALYSES_2022-2023/1_PUBLISH_MATERIALS/DATA/PUBLISH_All_XCandML_songdata_with_overlapzone_4.1.23.csv")
#to repeat analysis on only breeding season, read in the following file:
#ALL_Syll_Loc_Data_XCandML <- read.csv("C:/Users/xxime/Box/Ximena_Nicole/TOWHEE_ANALYSES_2022-2023/1_PUBLISH_MATERIALS/DATA/PUBLISH_breedingseasonONLY_XCandML_songdata_with_overlapzone_4.1.23.csv")
