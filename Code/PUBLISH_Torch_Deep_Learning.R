...
#grab only the song feature columns and the species column
...
accuracy #ALL: 0.892396 #Breeding: 0.9065574

balanced_accuracy <- cm$byClass["Balanced Accuracy"]
balanced_accuracy #ALL: 0.8965804 #Breeding: 0.9172072

kappa_result <- cm$overall["Kappa"]
kappa_result #ALL: 0.779686 #Breeding: 0.8033304

Mcnemar_pvalue <- cm$overall["McnemarPValue"] 
Mcnemar_pvalue #ALL: 0.001224283 #Breeding: 1.857718e-06
