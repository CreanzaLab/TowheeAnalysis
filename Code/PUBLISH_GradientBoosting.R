...
accuracy #ALL: 0.8794835 #Breeding: 0.9081967

balanced_accuracy <- cm$byClass["Balanced Accuracy"]
balanced_accuracy #ALL: 0.8822392 #Breeding: 0.9142931 

#calculate Cohen's kappa
kappa_result <- cm$overall["Kappa"]
kappa_result #ALL: 0.7528139 #Breeding: 0.8050139

Mcnemar_pvalue <- cm$overall["McnemarPValue"] 
Mcnemar_pvalue #ALL: 0.006377301 #Breeding: 0.0003085347
