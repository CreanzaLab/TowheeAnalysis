...
ALL_Syll_Loc_Data_NoOverlap <- subset(ALL_Syll_Loc_Data_NoOverlap, select = c(1, 4:19, 27, 20))
...
new_test_data <- subset(ALL_Syll_Loc_Data_OverlapONLY, select = c(1,4:19, 27))
